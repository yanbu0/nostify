...
### DoBulkCreateAsync / DoBulkUpsertAsync / DoBulkCreateEventAsync
...
Simulate bulk create/upsert/event-create operations. In exception mode, invokes `onException` callback with the first item/event and exception (when callback is provided), or throws. Otherwise completes successfully.
