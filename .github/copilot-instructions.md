...
- Package first: `dotnet pack` to create `bin/Release/nostify.5.0.0.nupkg`
- Install templates locally: `dotnet new install bin/Release/nostify.5.0.0.nupkg`
...
3. **Template validation**: 
   ...
   - `dotnet new install bin/Release/nostify.5.0.0.nupkg` to install templates
...
```bash
$ dotnet new install bin/Release/nostify.5.0.0.nupkg
Success: nostify::5.0.0 installed the following templates:
