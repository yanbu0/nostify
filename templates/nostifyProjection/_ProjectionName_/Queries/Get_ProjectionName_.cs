...
public class Get_ProjectionName_
{
    ...
    private readonly ILogger<Get_ProjectionName_> _logger;
    public Get_ProjectionName_(HttpClient httpClient, INostify nostify, ILogger<Get_ProjectionName_> logger)
    {
