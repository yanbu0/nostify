...
public class On_ReplaceMe_Created_For__ProjectionName_
{
    ...
    private readonly ILogger<On_ReplaceMe_Created_For__ProjectionName_> _logger;
    
    public On_ReplaceMe_Created_For__ProjectionName_(INostify nostify, HttpClient httpClient, ILogger<On_ReplaceMe_Created_For__ProjectionName_> logger)
    {
